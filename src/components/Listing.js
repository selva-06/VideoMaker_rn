...
//   const uploading = useSelector(state => state.upload.uploading); // Updated reducer reference

//   useEffect(() => {
//     // You may dispatch fetchListData or any other initial actions here
//   }, [dispatch]);
...
//           keyExtractor={item => item.id.toString()}
//         />
//         {uploading && <Text style={{color: 'black'}}>Uploading...</Text>}
//       </View>
//     </PaperProvider>
//   );
// };
